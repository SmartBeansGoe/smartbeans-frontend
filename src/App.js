      ...
      .then((response) => {
        this.setState({
          assets: [
            ...
            'troll-pants',
            'troll-hats',
            'das_doppelte_boehnchen-shirts',
            'das_doppelte_boehnchen-pants',
            'das_doppelte_boehnchen-hats',
            'kompilations_komplikationen-shirts',
            'kompilations_komplikationen-pants',
            'kompilations_komplikationen-hats',
            'nico_beanz-shirts',
            'nico_beanz-pants',
            'nico_beanz-hats',
            'bikini-shirts',
            ...
            'etwas_von_allem-pants',
            'etwas_von_allem-hats',
            'knight-armor-shirts',
            'knight-armor-pants',
            'knight-armor-hats',
            ...
            'debug-informatiker-hats',
            'climber_pants_no_rope-shirts',
            'climber_pants_no_rope-pants',
            'climber_pants_no_rope-hats',
            'maximiert-shirts',
            'maximiert-pants',
            'maximiert-hats',
            'granny-smith-shirts',
            ...
            'girlie_shirt_brown-pants',
            'girlie_shirt_brown-hats',
            'new-york-city-basic-shirts',
            'new-york-city-basic-pants',
            'new-york-city-basic-hats',
            'surfer-bean-shirts',
            'surfer-bean-pants',
            'surfer-bean-hats',
            'ole_beanz-shirts',
            ...
            'summer-feelings-male-hats',
            'abstract-art-shirts',
            'abstract-art-pants',
            'abstract-art-hats',
            'summer-feelings-female-shirts',
            'summer-feelings-female-pants',
