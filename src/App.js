...
export default class App extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      clothes: {
        shirts: ["Business_Bean_m_shirt", "Business_Bean_m_shirt_2", "bicycle_shirt", "french_shirt_red", "french_shirt", "granny_smith_shirt", "beanybuffer_dress", "gardener_shirts", "shirt_test", "summer_feelings_w_dress", "Summer_feelings_m_shirt", "shirt001", "ballerina_dress", "surferbohne_shirt", "bikini_shirt"],
        pants: ["Business_Bean_m_pants", "Business_Bean_m_pants_2", "french_pants_light_blue", "french_pants", "granny_smith_skirt", "bikini_pants", "Summer_feelings_m_pants", "pants001", "gardener_pants", "surferbohne_pants", "ballerina_legs"],
        hats: ["french_hat", "beanybuffer_hat", "granny_smith_hair", "summer_feelings_w_hat"],
      }
    };
